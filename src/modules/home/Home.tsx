...
export default function Home() {
    return (
        <div className='mx-auto p-4 md:p-0'>
            <div className={`w-full h-auto grid grid-cols-12 gap-8 md:px-4 md:items-center lg:bg-hero-bg lg:bg-cover lg:bg-bottom lg:px-4 lg:py-16 xl:py-24 xl:px-52`} >
            ...
            <div className="my-12 md:px-4 lg:px-4 xl:px-52" >
