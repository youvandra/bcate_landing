...
export default function Home() {
    return (
        <div className='mx-auto p-4 md:p-0'>
            {/* <div className={`w-full h-auto grid grid-cols-12 gap-8 md:px-4 md:items-center lg:bg-hero-bg lg:bg-cover lg:bg-bottom lg:px-4 lg:py-16 xl:py-24`} > */}
            <div className={`w-full h-auto md:items-center lg:bg-hero-bg lg:bg-cover lg:bg-bottom lg:py-16 xl:py-24`} >
                <div className="w-full md:px-4 max-w-screen-xl m-auto">
                    <div className='mb-4 mt-0 md:mt-10 lg:mb-0 flex flex-col space-y-6' >
