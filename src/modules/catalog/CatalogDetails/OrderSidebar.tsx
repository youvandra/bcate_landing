...
export default function OrderSidebar() {
    return (
        <div className="hidden w-1/5 rounded-xl p-4 lg:flex flex-col gap-6 h-fit">
            {/* <p className="font-semibold">Atur pesanan</p>
            ...
            <section>
                <button className="bg-gray-800 text-white p-2 w-full rounded-lg mb-2 hover:bg-gray-900">
                    <i className='bx bx-cart-add'></i> Checkout
                </button>
                <button className="border border-gray-800 text-gray-800 p-2 w-full rounded-lg">
