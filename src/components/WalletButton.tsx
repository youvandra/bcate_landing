...
export const WalletButton = () => {
  ...
  return (
    <>
      <button onClick={() => handleConnect()} type="button" className="hidden md:inline-block text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5">
        {status === 'initializing' || status === 'notConnected' ? 'Connect Wallet' : truncate(account_wallet, 4, 4, 11)}
      </button>
