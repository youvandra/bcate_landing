...
const Header = () => {
	...
	useEffect(() => {
		console.log(routes, walletAddress, 'sss');
		connectWallet();
	}, [routes]);
	return (
		<nav className="bg-white border-gray-200">
				...
				<div className="flex md:order-2">
					...
					<button
						...
						{!walletAddress
							? 'Connect Wallet'
							: walletAddress
							? truncate(walletAddress as string, 4, 4, 11)
							: ''}
					</button>
					<button
            ...
            <Link href="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0  ">Building</Link>
					...
					<li>
						<Link
							href="/about"
							className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 0 ">
							About
						</Link>
					</li>
					<li>
